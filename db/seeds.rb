...
m5 = Worldmap.create!(x:-1, y:1, name: "West of the Intersection", description: "What a long walk. The path to the West narrows. A light shines at what appears to be the end.", north: false, east: true, south: false, west: true)
m6 = Worldmap.create!(x:-2, y:1, name: "Large Clearing", description: "The sun intensifies and almost blinds you as you make your way through. You stumble over a root into and catch yourself and you notice you are no longer blinded. You stare in awe as a bird rapidly dives into a clear, blue lake and catches a small fish. There are mountains past the lake and more trees to the North.", north: false, east: true, south: false, west: false)

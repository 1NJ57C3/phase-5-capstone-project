...
u2 = User.create!(username:"Testing", password:"password")
...
m6 = Worldmap.create!(x:0, y:-1, name: "South of the Starting Area", description: "You walk through the trees. You don't know when it happened, but you suddenly find yourself in a large, empty, white space. A strange group of voices shout from within your mind: \"YOU DO NOT BELONG HERE, MORTAL! TURN BACK NOW!\"", north: true, east: false, south: false, west: false)
